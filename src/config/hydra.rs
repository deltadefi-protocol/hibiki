...
pub fn get_hydra_pp() -> Protocol {
    Protocol {
        ...
        price_mem: 0.0,
        price_step: 0.0,
        max_tx_ex_mem: "16000000000".to_string(),
        max_tx_ex_steps: "10000000000000".to_string(),
        max_block_ex_mem: "80000000000".to_string(),
        max_block_ex_steps: "40000000000000".to_string(),
        max_val_size: 5000,
